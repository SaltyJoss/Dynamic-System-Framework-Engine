...
namespace {
	...
	//) {
	//	VecX_T<DualNumber_T<Scalar, NVar>> dx = x;
	//	for (int i = 0; i < x.size(); ++i) { dx(i) = -2.0 * x(i); }
	//	return dx;
	//}
	...
	//) {
	//	VecX_T<DualNumber_T<Scalar, NVar>> dx = x;
	//	for (int i = 0; i < x.size(); ++i) { dx(i) = -100.0 * x(i); }
	//	return dx;
	//}
	...
	//		x = integrator.implicitEuler(x, t, dt, expDecay<double, 1>);
	//		t += dt;
	//	}
	...
	//	) {
	//		return integrator.implicitEuler(x, t, dt, expDecay<double, 1>);
	//	};
	//	verifyExpDecaySensitivity(stepFn, 1e-2, 1000); 
	//}
	//// Test case for the Implicit Midpoint method on the linear decay ODE.
	//TEST("AD Implicit Midpoint Method", ImplicitEuler_LinearDecay) {
	//	VecX_T<DualNumber_T<double, 1>> x(1);
	//	x(0) = DualNumber_T<double, 1>(1.0, { 0.0 });
	//	double T = 0.5;
	...
	//	for (int i = 0; i < 500; ++i) {
	//		x = integrator.implicitEuler(x, t, dt, linearDecay<double, 1>, 50, 1e-6);
	//		t += dt;
	//	}
	...
	//		DualNumber_T<double, 1> dt
	//	) {
	//		return integrator.implicitEuler(x, t, dt, linearDecay<double, 1>);
	//	};
	//	verifyExpDecaySensitivity(stepFn, 1e-2, 1000);
	//}
	...
	//	};
	//	for (int i = 0; i < 500; ++i) {
	//		x = integrator.implicitEuler(x, t, dt, stiff_f);
	//		t += dt;
	//	}
	...
	//		DualNumber_T<double, 1> dt
	//	) {
	//		return integrator.implicitEuler(x, t, dt, stiffDecay<double, 1>);
	//	};
	//	verifyExpDecaySensitivity(stepFn, 1e-2, 1000);
	//}
	...
	//	for (int i = 0; i < 10; ++i) {
	//		x = integrator.implicitEuler(x, t, dt, stiffDecay<double, 1>);
	//		t += dt;
	...
	//	DualNumber_T<double, 1> t(0.0, { 0.0 });
	//	for (int i = 0; i < 1000; ++i) {
	//		x = integrator.implicitMidpoint(x, t, dt, expDecay<double, 1>);
	//		t += dt;
	//	}
	...
	//		DualNumber_T<double, 1> dt
	//	) {
	//		return integrator.implicitMidpoint(x, t, dt, expDecay<double, 1>);
	//	};
	...
	//		x = integrator.implicitMidpoint(x, t, dt, harmonicOsc<double, 2>);
	//		t += dt;
	//	}
	...
	//	) {
	//		return integrator.implicitMidpoint(x, t, dt, harmonicOsc<double, 2>);
	//	};
	...
	//	DualNumber_T<double, 1> t(0.0);
	//	for (int i = 0; i < 500; ++i) {
	//		x = integrator.implicitMidpoint(x, t, dt, linearDecay<double, 1>);
	//		t += dt;
	//	}
	...
	//		DualNumber_T<double, 1> dt
	//	) {
	//		return integrator.implicitMidpoint(x, t, dt, linearDecay<double, 1>);
	//	};
	//	verifyExpDecaySensitivity(stepFn, 1e-3, 1000);
	//}
	...
	//	};
	//	for (int i = 0; i < 500; ++i) {
	//		x = integrator.implicitMidpoint(x, t, dt, stiff_f);
	//		t += dt;
	//	}
	...
	//		DualNumber_T<double, 1> dt
	//	) {
	//		return integrator.implicitMidpoint(x, t, dt, stiffDecay<double, 1>);
	//	};
	//	verifyExpDecaySensitivity(stepFn, 1e-3, 1000);
	//}
	//// Test large step performance of implicit midpoint
	...
	//	DualNumber_T<double, 1> prev = x(0);
	//	for (int i = 0; i < 10; ++i) {
	//		x = integrator.implicitMidpoint(x, t, dt, stiffDecay<double, 1>);
	//		t += dt;
	//		ASSERT_TRUE(std::abs(x(0).real) < std::abs(prev.real), "Not monotone");
	//		ASSERT_TRUE(std::abs(x(0).dual[0]) < std::abs(prev.dual[0]), "Not strictly decaying");
	//		prev = x(0);
