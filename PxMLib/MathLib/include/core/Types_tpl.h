...
namespace mathlib {
	// Template version of 2D vector
	template<typename Scalar>
	using Vec2_T = Eigen::Matrix<Scalar, 2, 1>;
	// Template version of 3D vector
	template<typename Scalar>
	using Vec3_T = Eigen::Matrix<Scalar, 3, 1>;
	// Template version of 4D vector (e.g., for homogeneous coordinates)
	template<typename Scalar>
	using Vec4_T = Eigen::Matrix<Scalar, 4, 1>;
	// Template version of 3x3 matrix
	template<typename Scalar>
	using Mat2_T = Eigen::Matrix<Scalar, 2, 2>;
	// Template version of 3x3 matrix
	template<typename Scalar>
