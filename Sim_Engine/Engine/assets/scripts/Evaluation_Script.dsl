...
parallel(0.0) {
	...
	trajSet(link06, TRAP,   0.0, 120.0, 220.0)
}
wait(2.6)
wait(0.30)
...
parallel(0.0) {
	...
	trajSet(link04, TRAP,   0.0, 100.0, 200.0)
	trajSet(link05, TRAP,   0.0, 100.0, 200.0)
	trajSet(link06, TRAP,   0.0, 130.0, 240.0)
}
wait(1.8)
wait(0.20)
...
parallel(0.0) {
	...
	trajSet(link04, TRAP,   0.0, 120.0, 240.0)
	trajSet(link05, TRAP,   0.0, 120.0, 240.0)
	trajSet(link06, TRAP,   0.0, 150.0, 280.0)
}
wait(2.0)
wait(0.20)
...
# ------------------------------------------------------------
parallel(0.0) {
	trajSet(link01, TRAP,   0.0, 110.0, 240.0)
	trajSet(link02, TRAP,  85.0, 90.0, 200.0)
	trajSet(link03, TRAP, -85.0, 90.0, 200.0)
	trajSet(link04, TRAP,   0.0, 140.0, 260.0)
	trajSet(link05, TRAP,   0.0, 140.0, 260.0)
	trajSet(link06, TRAP,   0.0, 170.0, 300.0)
}
wait(2.2)
wait(0.20)
...
parallel(0.0) {
	...
	trajSet(link06, TRAP,   20.0, 110.0, 200.0)
}
wait(2.8)
wait(0.35)
