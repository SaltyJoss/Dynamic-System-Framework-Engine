# ============================================================
# JOINT-01 DAMPING/FRICTION INDENTIFICATION
# - Designed to identify the correct coefficients for this joint
# - I created this to fit my coefficients to the joints, using PD not PID (I make K_I > 0 once fitted)
#
# Joint limits (deg):
# J1: [-150, +150]
# J2: [   0, +170]
...
# --- Speed set 1 (slow) ---
trajSet(link03, TRAP, -90.0, 30.0, 120.0)
wait(2.5)
...
# --- Speed set 2 (medium) ---
trajSet(link03, TRAP, -90.0, 60.0, 240.0)
wait(2.0)
