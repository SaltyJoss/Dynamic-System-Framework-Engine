# ============================================================
# JOINT-02 DAMPING/FRICTION INDENTIFICATION
...
# --- Speed set 1 (slow) ---
trajSet(link02, TRAP, 75.0, 30.0, 60.0)
wait(2.0)
trajSet(link02, TRAP, 15.0, 30.0, 60.0)
wait(2.0)
...
# --- Speed set 2 (medium) ---
trajSet(link02, TRAP, 75.0, 60.0, 120.0)
wait(1.5)
trajSet(link02, TRAP, 15.0, 60.0, 120.0)
wait(1.5)
...
# --- Speed set 3 (fast) ---
trajSet(link02, TRAP, 75.0, 120.0, 240.0)
wait(1.2)
trajSet(link02, TRAP, 15.0, 120.0, 240.0)
wait(1.2)
