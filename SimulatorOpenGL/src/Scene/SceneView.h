...
namespace gui {
    ...
    public:
            ...
            _light(nullptr), _size(3840, 2160)
        {
            ...
            _shader->load("assets/shaders/vs_pbr.vert.glsl", "assets/shaders/fs_pbr.frag.glsl");

            _worldGridShader = std::make_unique<shaders::Shader>();
            _worldGridShader->load("assets/shaders/world_grid.vert.glsl", "assets/shaders/world_grid.frag.glsl");

            _shadowShader = std::make_unique<shaders::Shader>();
            _shadowShader->load("assets/shaders/shadow_depth.vert.glsl", "assets/shaders/shadow_depth.frag.glsl");
